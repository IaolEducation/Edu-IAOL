      ...
      <div className="w-full max-w-md space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Use your Google account to continue. Email sign-in is optional.
          </p>
        </div>

        {/* Primary: Google Sign-In (required) */}
        <div className="space-y-4">
          ...
          {!showEmailForm ? (
            ...
            <form className="space-y-4 rounded-lg border p-4" onSubmit={handleEmailSubmit}>
